...
urlpatterns = patterns('',
    ...
    url(r'^register_merchant/$', views.register_merchant, name='register_merchant'),
    url(r'^view_merchants/$', views.view_merchants, name='view_merchants'),
    ...
    url(r'^rate_merchant/(?P<merchant_id>[0-9]+)/$', views.rate_merchant, name='rate_merchant'),
